...
# ФУНКЦИЯ ВЫБОРА ИЛИ ВВОДА СТАТУСА
def add_status_loop():
...
print(g + '* * ВАС ПРИВЕТСТВУЕТ МЕНЕДЖЕР ЗАМЕТОК 1.2.2 * *')
print(y+'\nДля проверки задания отредактируйте статус предустановленной заметки и выведите список заметок')
